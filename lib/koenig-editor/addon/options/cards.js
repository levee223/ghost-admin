...
export const CARD_MENU = [
    {
        ...
        }, {label: 'Video', icon: 'koenig/kg-card-type-video', iconClass: 'kg-card-type-native', matches: ['video'], type: 'card', replaceArg: 'video', params: ['src'], payload: {triggerBrowse: true}},
        {
            label: 'Markdown',
