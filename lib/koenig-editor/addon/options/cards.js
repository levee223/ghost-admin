...
export const CARD_COMPONENT_MAP = {
    hr: 'koenig-card-hr',
    image: 'koenig-card-image', video: 'koenig-card-video',
...
export const CARD_ICON_MAP = {
    ...
    image: 'koenig/kg-card-type-image', video: 'koenig/kg-card-type-video',
...
export default [
    ...
    }}), createComponentCard('video', {hasEditMode: false, deleteIfEmpty(card) { return card.payload.videoSelector && !card.payload.src; }}),
...
export const CARD_MENU = [
    {
        ...
        }, {label: 'Video', icon: 'koenig/kg-card-type-video', desc: 'Upload, or embed with /video [url]', iconClass: 'kg-card-type-native', matches: ['video'], type: 'card', replaceArg: 'video', params: ['src'], payload: {triggerBrowse: true}},
        {
            label: 'Markdown',
